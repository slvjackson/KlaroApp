...
const TEMPLATES = [
  ...
  },
  {
    ...
    blurb: "Entradas e saídas diárias com gráfico de evolução e fechamento.",
    icon: TrendingUp,
    badge: "Em breve",
    available: false,
  },
...
const SECTIONS = [
  ...
  { id: "txs",        label: "Listagem de transações" },
] as const;
...
function ReportConfigurator({
  ...
  const [sections, setSections] = useState<Set<SectionId>>(
    () => new Set<SectionId>(["kpis", "health", "monthly", "topExpense", "topIncome"]),
  );
